...
public class C1_StringManipulation01 {
	...
	public static void main(String[] args) {
        ...
        System.out.println(name1.equals(name3)); // True (equals() methodu sadace icerik kontrolu yapar esit olmasi yeterlidir)
        System.out.println(name2.equals(name6)); // True (equals() methodu sadace icerik kontrolu yapar esit olmasi yeterlidir)
        ...
        // degerleri karsilastirmak ve supriz yasamak istiyorsaniz equals() kullanmalisiniz
