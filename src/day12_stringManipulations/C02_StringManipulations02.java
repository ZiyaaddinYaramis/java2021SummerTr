...
public class C02_StringManipulations02 {
	...
	public static void main(String[] args) {
		...
		String soyisimDuzenlenmis = soyisim.substring(0,1).toUpperCase() + // ilk
				soyisim.substring(1).replaceAll("\\S", "*");
		
		
		String kartNoBasiDuzenlenmis = "**** **** **** ";
		String kartNoSonuDuzenlenmis = kkNo.substring(kkNo.length() - 4);
		
		
		
		System.out.println(isimDuzenlenmis + soyisimDuzenlenmis);
		System.out.println(kartNoBasiDuzenlenmis + kartNoSonuDuzenlenmis);
